...
#     gstIN: Mapped[str] = mapped_column(String, unique=True, index=True, nullable=False)
#     operating_status: Mapped[str] = mapped_column(String, default="Open")  # 'Open' or 'Closed'
#     kitchen_status: Mapped[str] = mapped_column(String, default="Normal") # 'Normal', 'Busy', or 'Emergency'
#     delivery_status: Mapped[str] = mapped_column(String, default="Active") # 'Active' or 'Inactive'
